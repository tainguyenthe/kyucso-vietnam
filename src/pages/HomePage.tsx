  ...
  return (
    <div>
      ...
      <section className="relative bg-gradient-to-b from-maroon-800 via-maroon-700 to-sunset-700 text-white overflow-hidden">
        <div className="absolute inset-0 bg-[url('/src/assets/logo-vn.jpg')] bg-cover bg-center opacity-20" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-16 text-center">
